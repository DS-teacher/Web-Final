...
setInterval("document.getElementById('dateTime').innerHTML = (new Date()).format('今天是yyyy年MM月dd日，心情惬意，学习Java☕');", 1000);
...
(function ($, f) {
    var Unslider = function () {
        ...
        //  Set some options
        _.o = {
            speed: 400,     // animation speed, false for no transition (integer or boolean)
